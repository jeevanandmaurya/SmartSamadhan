function ContactUs() {
  return (
    ...
    <p className="card" style={{ marginTop: 16, fontSize: 14 }}>For reporting/support on technical issues send email at : cpgrams-darpg[at]nic[dot]in</p>
  </div>
  );
}
